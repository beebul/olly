$(document).ready(function() {
    ...
    var userFeed = new Instafeed({
        ...
        sortBy: 'most-recent',
        template: '<div class="4u 4u(medium) 6u(small) 12u(xsmall) instaimg"><a href="{{image}}" title="{{caption}}" target="_blank"><img src="{{image}}" alt="{{caption}}" height="320px" class="img-fluid"/></a></div>',
    });
    userFeed.run();
